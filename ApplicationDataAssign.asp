<%
    'Application data assignment, limited to assigning strings. Will need a way to define non-string objects. 
dim ApplicationVarName
dim ApplicationVarValue
    'Stop
...
If Request.ServerVariables("REMOTE_ADDR") = Request.ServerVariables("LOCAL_ADDR") then
    If Request.ServerVariables("REQUEST_METHOD") = "POST" Then
        For Each strItem In Request.Form 
            Application(strItem) = ResolveType( Request.Form(strItem) )
